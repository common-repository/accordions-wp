...
<div class="wrap">
	...
	<div class="postbox team-manager-admin-area">
		...
		<p><?php echo esc_html__( 'Upgrading to the', 'tcaccordion' ); ?> <a href="https://themepoints.com/product/wp-accordions-pro/" target="_blank"><span style="color: red;text-decoration:none;"> <?php echo esc_html__( 'Premium Version', 'tcaccordion' ); ?></span></a> <?php echo esc_html__( 'would unlock more amazing features of this plugin.', 'tcaccordion' ); ?></p>
	</div>
</div>